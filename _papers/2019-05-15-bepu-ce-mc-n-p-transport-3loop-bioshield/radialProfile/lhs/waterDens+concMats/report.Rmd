...
ggplot(allResponses, aes(rPos, maxRadial, color=case)) +
  ...
  labs(x="Radial Position (cm)",
       ...
       subtitle="(Full-scale 3D CE (ENDF/B-VII.1) SCALE/MAVRIC model via DAKOTA; 240 samples; 15 inputs; 2-sig errs)") +
  theme_minimal() +
...
save(data, allResponses, tSumm, plotSumm, tableBEvUQ, file="1dLHS15vars.RData")
```
